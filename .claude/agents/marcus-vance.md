...
- `references/api-news-and-collector.md` — News crawlers, Collector, Perplexity Search
...
- `references/html-report-styles.md` — HTML report design system
...
Follow `references/orchestration-protocol.md` tier definitions:
...
For HTML reports, follow `references/html-report-styles.md` styling. Charts use Plotly.js with data embedded as inline JS variables.
...
- VCI returns 403 → fallback `source="KBS"` (see `references/common-patterns.md`)
